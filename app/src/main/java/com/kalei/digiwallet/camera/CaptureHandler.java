 ...
 */
final public class CaptureHandler extends Handler {
    ...
    public CaptureHandler(CaptureActivity activity, CameraManager cameraManager, boolean isContinuousModeActive) {
