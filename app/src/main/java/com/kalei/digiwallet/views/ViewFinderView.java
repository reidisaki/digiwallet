package com.kalei.digiwallet.views;
/*
...
import com.kalei.digiwallet.camera.CameraManager;
...
/**
 * This view is overlaid on top of the camera preview. It adds the viewfinder rectangle and partial transparency outside it, as well as the result text.
 * <p/>
...
public final class ViewfinderView extends View {
     ...
     */
    public static final boolean DRAW_TRANSPARENT_WORD_BACKGROUNDS = false;
     ...
     */
    public static final boolean DRAW_WORD_TEXT = false;

    /**
     * Flag to draw each character in its respective box from TessBaseAPI::GetCharacters().
     */
    public static final boolean DRAW_CHARACTER_TEXT = false;
